...
public class UserService implements IUserService {
    ...
    public Map<String, String> getStudent() {
        Map<String, String> staffs = new TreeMap<>();
        List<UserEntity> userEntities = userRepository.findByStatusAndRoles_Code(1,"STUDENT");
        for(UserEntity it : userEntities){
            staffs.put(it.getUserName(),it.getUserName());
        }
        return staffs;
    }

    @Override
    public Map<Long, String> getTeacher() {
        Map<Long, String> staffs = new HashMap<>();
        List<UserEntity> userEntities = userRepository.findByStatusAndRoles_Code(1,"TEACHER");
        for(UserEntity it : userEntities){
